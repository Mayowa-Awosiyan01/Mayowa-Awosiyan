  ...
  return (
    <div className="m-6">
      ...
      <p className="text-center p-8 px-12">
        Below you will find some descriptions of my projects, some of which are
        still in progress. I will be updating this page as they progress and as
        new ones start.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
        <div className="p-4">
          <p>
            ...
            created using the JavaScript library react-particles-js. Some things
            I want to add to this website include: a button to change the
            animated background to different styles and changing the skills on
            the homepage so when they are clicked they give a more detailed
            picture on how I have used the skill.
          </p>
        </div>
        <div className="p-4">
          <Image
